# Codex — Astrid Windows operational adapter

*Local Codex CLI workflow for the Astrid Windows app.*
...
*This file is for Codex. Claude Code reads [CLAUDE.md](./CLAUDE.md) (same content). All architecture
