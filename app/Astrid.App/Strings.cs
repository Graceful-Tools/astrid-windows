...
internal static class Strings
{
    ...
    private static readonly Dictionary<string, string> Fallback = new(StringComparer.Ordinal)
    {
        ...
        ["passkeys.note"] = "Passkeys sign you in without a password. Adding one happens in the browser; renaming and revoking happen here.",
        ["passkeys.none"] = "No passkeys registered yet.",
        ["passkeys.add"] = "Add a passkey in the browser",
        ["passkeys.added"] = "Added ",
        ["passkeys.synced"] = "Synced",
        ["passkeys.rename"] = "Rename",
        ["passkeys.revoke"] = "Revoke",
        ["passkeys.rename_prompt"] = "Name this passkey",
        ["passkeys.revoke_confirm"] = "Revoke this passkey? You will no longer be able to sign in with it.",
        ["passkeys.revoke_yes"] = "Revoke it",
        ...
        ["settings.tasks_line"] = "Default task behaviour and email-to-task preferences",
        ["settings.agents_line"] = "AI assistants and coding agents, with your API keys",
        ["settings.api_access_line"] = "OAuth applications and API integrations",
        ["settings.contacts_line"] = "Import contacts for collaborator suggestions",
        ["settings.appearance_line"] = "Theme, colours, and the quick-add shortcut",
        ["settings.integrations_line"] = "Google lists, the webhook, and Copilot",
        ["settings.data_line"] = "Download all your tasks, lists, and account data",
        ["settings.help_line"] = "Troubleshooting guides and contact support",
        ["settings.privacy_line"] = "How your data is handled",
        ["settings.terms_line"] = "The terms you agreed to",
        ...
        ["settings.api_access"] = "API access",
        ["settings.integrations"] = "Integrations",
        ["settings.data"] = "Your data",
        ["comments.delete_confirm"] = "Delete this comment?",
        ["comments.delete_yes"] = "Delete it",
        ["reminder.toast_complete"] = "Complete",
        ["reminder.toast_snooze"] = "Snooze {0} min",
        ["timer.hours_minutes"] = "{0}h {1}m",
        ["timer.minutes"] = "{0}m",
        ["ordinal.st"] = "{0}st",
        ["ordinal.nd"] = "{0}nd",
        ["ordinal.rd"] = "{0}rd",
