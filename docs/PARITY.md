...
| Attachments | ✅ | ✅ | Open, attach from disk, paste from the clipboard; drawn in the comment they arrived on. Queued offline, with the bytes copied so the original can move away |
